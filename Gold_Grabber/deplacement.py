...
def tp(window,coins, Inventaire) :
    window.withdraw()
    #cree une fentre 
    ...
    if coins >=10000 :
        ...
        Jetons = str(coins)
        #bouton deplacement
        morpion_bouton = Button(window_deplacement, text="Morpion",pady=122, padx=95 ,font=("Super Legend Boy",30), bg= 'black',fg='white',width=8,relief=GROOVE, bd=7.5,command=lambda: Morpion(window_deplacement, coins, Inventaire, Objet))
        ...
        shop_bouton =Button(window_deplacement, text="Boutique",pady=122, padx=95 , font=("Super Legend Boy",30), bg= 'black',fg='white', width=8,relief=GROOVE, bd=7.5,command=lambda:boutique(window_deplacement, coins, Inventaire))
...
def machine_a_sous(window,Jetons, Inventaire, Objet):
    ...
    def window_resultat(fenetre, Result, Jetons, Mise, Inventaire, Objet):
        ...
        if  case_1 == case_2 and case_2 == case_3 :
            ...
            quit = Button(window_resultat, text= "QUITTER !", font= ("Super legend boy" , 20) , bg = 'black' , fg = 'white' , command =lambda:tp(window_resultat,Jetons, Inventaire))
            quit.pack()
            ...
            quit = Button(window_resultat, text= "QUITTER !", font= ("Super legend boy" , 20) , bg = 'black' , fg = 'white' , command =lambda:tp(window_resultat,Jetons, Inventaire)).pack()
            window_resultat.mainloop()
    ...
    def resultat_window(window, Choix, Mise, coins, Inventaire, Objet):
        ...
        if Choix == Gagnant :
            ...
            if Objet == "Quitte ou triple":
                ...
                Inventaire[0] = Inventaire[0]-1
            coins = coins + Mise
            Label(Jeu, text="Vous avez gagné !",font= ("Super legend boy" , 20) , bg = 'black' , fg = 'white').pack(expand=YES)
            Label(Jeu, text=("Vous disposez de",coins, "coins"),font= ("Super legend boy" , 20) , bg = 'black' , fg = 'white').pack(expand=YES)
            quit = Button(Jeu, text= "QUITTER !", font= ("Super legend boy" , 20) , bg = 'black' , fg = 'white' , command = lambda:tp(Jeu,coins, Inventaire))
            quit.pack()
            Jeu.mainloop()
        else :
            ...
            if Objet == "Quitte ou triple":
                ...
                Inventaire[1] = Inventaire[1]-1
            coins = coins-Mise
            Label(Jeu, text = "Vous avez perdu.",font= ("Super legend boy" , 20) , bg = 'black' , fg = 'white').pack(expand=YES)
            Label(Jeu, text=("Vous disposez de",coins, "coins"),font= ("Super legend boy" , 20) , bg = 'black' , fg = 'white').pack(expand=YES)
            quit = Button(Jeu, text= "QUITTER !", font= ("Super legend boy" , 20) , bg = 'black' , fg = 'white' , command = lambda:tp(Jeu,coins, Inventaire))
            quit.pack()
            Jeu.mainloop()
...
def Morpion (window,coins,objet, obj):
    window.withdraw()
    ...
    Button_Inventory = Button(Frame_Box,text="objet_use",font=("Super legend boy", 40),padx=150,pady=100,bg='black',fg='white',command=lambda:bag_morpion(Windows_real_Game,coins,objet,obj))
    Button_Start = Button(Frame_Box,text= "Start",font=("Super legend boy", 60),bg='black',fg='white',padx=150,pady=75,command= lambda : Pari(Windows_real_Game,coins,objet, obj))
...
def Pari(Window,coins,objet, obj):
    ...
    #Les boutons de mise
    btn_100 = Radiobutton(Window_Bet , text = 100 ,font= ("Super legend boy" , 30) , bg = 'black' , fg = 'white' ,variable= IntMise, value = 100,command = lambda : Game_Morpion(Window_Bet,coins,100,objet, obj))#, action(IntMise, 100)], indicatoron=0)
    btn_100.pack(expand=YES)
    
    btn_250 = Radiobutton(Window_Bet , text = 250,font= ("Super legend boy" , 30) , bg = 'black' , fg = 'white',variable= IntMise, value = 250, command = lambda : Game_Morpion(Window_Bet,coins, 250,objet, obj))#, action(IntMise, 250)], indicatoron=0)
    btn_250.pack(expand=YES)
    
    btn_500 = Radiobutton(Window_Bet , text = 500,font= ("Super legend boy" , 30) , bg = 'black' , fg = 'white' ,variable= IntMise, value = 500,command = lambda : Game_Morpion(Window_Bet,coins, 500,objet, obj))#, action(IntMise, 500)], indicatoron=0)
    btn_500.pack(expand=YES)
    
    btn_1000 = Radiobutton(Window_Bet , text = 1000,font= ("Super legend boy" , 30) , bg = 'black' , fg = 'white' ,variable= IntMise, value = 1000,command = lambda : Game_Morpion(Window_Bet,coins, 1000,objet, obj))#, action(IntMise, 1000)], indicatoron=0)
    btn_1000.pack(expand=YES)
    
    btn_all = Radiobutton(Window_Bet , text = "All in",font= ("Super legend boy" , 30) , bg = 'black' , fg = 'white' ,variable= IntMise, value = coins, command = lambda : Game_Morpion(Window_Bet,coins, coins,objet, obj))#, action(IntMise, coins)], indicatoron=0)
    btn_all.pack(expand=YES)
...
def bag_morpion(window,coins,Inventaire, obj) :
    window.withdraw()
    Window_shop = Toplevel(window)
    #taille/nom/logo
    Window_shop.title("GOLD GRABBER")
    ...
    number_item_1=Label(Window_shop,text=lettre_1, font=("Super Legend Boy",20), bg='black',fg='white',height=3,width=5 )
    number_item_1.grid(row=0,column=1,pady=5)
    Button_item_1=Button(Window_shop, text="use", font=("Super Legend Boy",20), bg='black',fg='white',height=3,width=5,relief=GROOVE, bd=7.5,command= lambda : [Morpion(Window_shop, coins, Inventaire, "Quitte ou triple")])
    Button_item_1.grid(row=0,column=2,pady=5)
    if Inventaire[0]==0:
        changeState(Button_item_1)
    #Idem
    ...
    number_item_2=Label(Window_shop,text=lettre_2, font=("Super Legend Boy",20), bg= 'black',fg='white',height=3,width=5 )
    number_item_2.grid(row=1,column=1,pady=5)
    Button_item_2=Button(Window_shop, text="use", font=("Super Legend Boy",20), bg= 'black',fg='white',height=3,width=5,relief=GROOVE, bd=7.5,command=lambda:Morpion(Window_shop, coins, Inventaire, "Bouclier"))
    Button_item_2.grid(row=1,column=2,pady=5)
    if Inventaire[1]==0:
        changeState(Button_item_2)
    #Idem
    ...
    number_item_3=Label(Window_shop,text=lettre_3, font=("Super Legend Boy",20), bg= 'black',fg='white',height=3,width=5 )
    number_item_3.grid(row=2,column=1,pady=5)
    Button_item_3=Button(Window_shop, text="use", font=("Super Legend Boy",20), bg= 'black',fg='white',height=3,width=5,relief=GROOVE, bd=7.5,command=lambda:tp(Window_shop, coins, Inventaire, obj))
    Button_item_3.grid(row=2,column=2,pady=5)
    if Inventaire[2]==0:
        changeState(Button_item_3)
    #Bouton quitter au cas où on n'a pas d'objet
    Button_Quitte = Button(Window_shop,text="Exit",font=("Super Legend Boy",20), bg= 'black',fg='white',height=3,width=25,relief=GROOVE, bd=7.5, command= lambda :Morpion(Window_shop, coins, Inventaire, obj))
    Button_Quitte.grid(row=3,column=0,columnspan=4,pady=5) 
    Window_shop.mainloop()

def Game_Morpion (Window,coins,mise,objet,obj):
    ...
    def Game(Windows_Principale,Nbr,List_Vérif,List_Map,Turn,coins,mise,objet, obj):
        Winner = False
        if not Winner:
            Button_Game(Nbr)
            ...
            Win_Condition(Windows_Principale,List_Map,Turn,coins,mise,objet, obj)
    ...
    Button_1 = Button(Frame_Game, text="1", padx=50, pady=20,font= ("Super legend boy" , 30),command= lambda : Game(Windows_Principale,1,List_Vérif,List_Map,Turn,coins,mise,objet, obj))
    Button_2 = Button(Frame_Game, text="2", padx=50, pady=20,font= ("Super legend boy" , 30),command= lambda : Game(Windows_Principale,2,List_Vérif,List_Map,Turn,coins,mise,objet, obj))
    Button_3 = Button(Frame_Game, text="3", padx=50, pady=20,font= ("Super legend boy" , 30),command= lambda : Game(Windows_Principale,3,List_Vérif,List_Map,Turn,coins,mise,objet, obj))
    Button_4 = Button(Frame_Game, text="4", padx=50, pady=20,font= ("Super legend boy" , 30),command= lambda : Game(Windows_Principale,4,List_Vérif,List_Map,Turn,coins,mise,objet, obj))
    Button_5 = Button(Frame_Game, text="5", padx=50, pady=20,font= ("Super legend boy" , 30),command= lambda : Game(Windows_Principale,5,List_Vérif,List_Map,Turn,coins,mise,objet, obj))
    Button_6 = Button(Frame_Game, text="6", padx=50, pady=20,font= ("Super legend boy" , 30),command= lambda : Game(Windows_Principale,6,List_Vérif,List_Map,Turn,coins,mise,objet, obj))
    Button_7 = Button(Frame_Game, text="7", padx=50, pady=20,font= ("Super legend boy" , 30),command= lambda : Game(Windows_Principale,7,List_Vérif,List_Map,Turn,coins,mise,objet, obj))
    Button_8 = Button(Frame_Game, text="8", padx=50, pady=20,font= ("Super legend boy" , 30),command= lambda : Game(Windows_Principale,8,List_Vérif,List_Map,Turn,coins,mise,objet, obj))
    Button_9 = Button(Frame_Game, text="9", padx=50, pady=20,font= ("Super legend boy" , 30),command= lambda : Game(Windows_Principale,9,List_Vérif,List_Map,Turn,coins,mise,objet, obj))
    ...
    #Win condition
    def Win_Condition(Windows_Principale,List_Map,Turn,coins,mise,objet, obj):
        if List_Map[0][1] == List_Map[0][2] and List_Map[0][2] == List_Map[0][0]:
                if List_Map[0][1] == 'X':
                    Win(Windows_Principale,1,coins,mise,objet, obj)
                else:
                    Win(Windows_Principale,2,coins,mise,objet, obj)
            ...
            if List_Map[0][2] == 'X':
               ...
               Win(Windows_Principale,2,coins,mise,objet, obj) 
        if Turn[0] == 9 :
            Win(Windows_Principale,3,coins,mise,objet,obj)
    ...
    def Win (Windows_Principale,Winner,coins,mise,objet,obj):
        if obj == "Double ou triple" :
            objet[0]=objet[0]-1
            if Winner == 1 :
                Label(Windows_Principale).pack
                coins = int(coins + mise/2*3)
